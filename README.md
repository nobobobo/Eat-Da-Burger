...
This Web Application uses MySQL database and Express server as Backend, and allows users to add burgers they want to devour.

The frontend template is built by handlebars.
...
The app is hosted at Heroku: [Eat Da Burger!](https://mysterious-stream-88582.herokuapp.com/)
...
Feel free to check [issues page](https://github.com/nobobobo/Eat-Da-Burger/issues).<a name="test"></a>
# 6. Tests 
